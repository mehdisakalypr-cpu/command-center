...
export async function GET(req: NextRequest) {
  const [
    ...
    supabase.from('seo_pages').select('*', { count: 'exact', head: true }).catch(() => ({ count: 0 })),
    supabase.from('social_posts').select('*', { count: 'exact', head: true }).catch(() => ({ count: 0 })),
    supabase.from('youtube_insights').select('*', { count: 'exact', head: true }),
    supabase.from('market_trends').select('*', { count: 'exact', head: true }).catch(() => ({ count: 0 })),
    supabase.from('influencer_profiles').select('*', { count: 'exact', head: true }).catch(() => ({ count: 0 })),
    supabase.from('deal_flows').select('*', { count: 'exact', head: true }).catch(() => ({ count: 0 })),
