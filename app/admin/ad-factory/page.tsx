  ...
  return (
    <div style={{ background: C.bg, color: C.text, minHeight: '100vh', fontFamily: 'Inter, system-ui, sans-serif' }}>
      <div style={{ maxWidth: 1100, margin: '0 auto', padding: '48px 24px' }}>
        <div style={{ fontSize: 11, color: C.accent, letterSpacing: '.22em', textTransform: 'uppercase' }}>Ops · Cross-product</div>
        ...
        <p style={{ color: C.muted, fontSize: 15, lineHeight: 1.6, marginBottom: 32, maxWidth: 700 }}>
          Pipeline centralisé de génération d'ads vidéo (FTG, OFA hero, Estate, Shift). Crée des avatars IA (nano-banana + Flux cascade),
