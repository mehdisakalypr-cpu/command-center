...
const NAV_GROUPS: NavGroupX[] = [
  ...
  },
  {
    label: 'Agents', icon: '⚡', items: [
      ...
      { href: '/admin/optimus/coverage',  label: 'Optimus Coverage',  icon: '📡', desc: 'Fraîcheur candles par venue × symbol × timeframe', subgroup: 'Trading' },
      { href: '/admin/optimus/backtests', label: 'Optimus Backtests', icon: '📊', desc: 'Résultats runs batch · KPIs sharpe · 100 derniers', subgroup: 'Trading' },
