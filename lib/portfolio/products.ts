...
export const PORTFOLIO_PRODUCTS: PortfolioProduct[] = [
  ...
  },
  {
    ...
    colorAccent: '#0EA5E9',
    colorBg: '#1A0810',
    baseUrl: 'https://ancf-mehdisakalypr-3843s-projects.vercel.app',
    repoOwner: 'mehdisakalypr-cpu',
    repoName: 'ancf',
    repoBranch: 'main',
    appDir: 'app',
  },
  {
    ...
    colorAccent: '#A855F7',
    colorBg: '#070B18',
    baseUrl: 'https://ivai-gray.vercel.app',
    repoOwner: 'mehdisakalypr-cpu',
    repoName: 'ivai',
    repoBranch: 'main',
    appDir: 'app',
  ...
  },
  {
    ...
    colorAccent: '#22D3EE',
    colorBg: '#160714',
    baseUrl: 'https://pfai-tan.vercel.app',
    repoOwner: 'mehdisakalypr-cpu',
    repoName: 'pfai',
    repoBranch: 'main',
    appDir: 'app',
  },
  {
    ...
    colorAccent: '#F97316',
    colorBg: '#08120B',
    baseUrl: 'https://arai-mu.vercel.app',
    repoOwner: 'mehdisakalypr-cpu',
    repoName: 'arai',
    repoBranch: 'main',
    appDir: 'app',
