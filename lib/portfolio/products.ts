...
export type PortfolioProduct = {
  ...
  appDir: string
  /**
   * Pages that must NEVER be regenerated by the cron — typically hand-crafted
   * pages whose quality the LLM cascade can't match (e.g. aici/demo with a
   * deep strategic intel report on a real brand). The /admin "Build all"
   * button skips these, and the cron tick endpoint refuses to claim them.
   */
  frozenPages?: PageType[]
}
