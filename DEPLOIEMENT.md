...
| Session 8 | enrich-dayuse.mjs v2 : capture notes (/5→/10), review_count, prix estimé nuit (day-use×2.5) ; couverture villes 14→62 (Europe, Asie, Moyen-Orient, Amériques) ; enrich-restaurants.mjs (schema.org + Wikipedia, cuisine, Michelin) ; generate-static.mjs exporte detail ; directory.html : restaurants avec cuisine/Michelin dans la modal, carte mode Jour par défaut |
